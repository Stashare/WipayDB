...
import ke.co.stashare.wipaydb.Adapter.ArtistList;
import ke.co.stashare.wipaydb.Models.Artist;

public class MainActivity extends AppCompatActivity {

    //we will use these constants later to pass the artist name and id to another activity
    public static final String ARTIST_NAME = "ke.co.stashare.wipaydb.artistname";
    public static final String ARTIST_ID = "ke.co.stashare.wipaydb.artistid";
